...
U eNeschopenek, které jsou vedeny jiným správcem pojištění, než je ČSSZ, se zobrazuje pouze číslo bez dalších údajů (stav, název PZS, jméno lékaře), protože ČSSZ nemá tyto údaje k dispozici.

Zároveň byla upravena funkcionalita kontroly při zakládání nové eNeschopenky. Pokud existuje aktivní neschopenka, tak je uživatel vyzván, zda přesto chce vystavit novou, nebo převzít stávající. V seznamu stávajících aktivních eNeschopenek vybere konkrétně tu, kterou přebere.
