...
2. V pravém spodním rohu jsou zobrazeny informace o vybraném léku včetně vzájemných interakcí předepisovaných medikací. Po kliknutí na tlačítko Předepsat se vybraný lék se zařadí mezi

3. předepsané léky v pravém horním rohu. Zobrazeny jsou tak, jak budou na receptu. Z tohoto okna lze recepty odesílat kliknutím na ikonu eRecept.

4. Pokud se lékař bude chtít dozvědět o léku nějaké bližší informace, klikne buď na tlačítko SPC (Ctrl+U) a zobrazí se mu informace o léku firmy PharmData nebo pod tlačítkem PIL (Ctrl+l) najde příbalový leták dané medikace.  Podmínkou je připojení na internet.
