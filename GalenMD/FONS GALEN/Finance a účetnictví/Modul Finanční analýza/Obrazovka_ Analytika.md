...
Poskytuje přehled o **počtu vykázaných bodů a počtu unikátních pojištěnců** v čase. Uživatel zde může porovnávat více období:

- **Aktuální období** – údaje za právě sledovaný rok (resp. období vybrané v horní části obrazovky)
- **Referenční období** – historické údaje, jedná se o předminulý rok, které slouží k porovnání dle metodiky
- **Mezidobí** – období mezi aktuálním a referenčním rokem, které umožňuje sledovat průběžný vývoj.

*Příklad: Pokud je aktuální rok 2025, tak referenčním rokem je rok 2023 a mezidobí je 2024.*

**Všechna období jsou přepočítána podle aktuální úhradové vyhlášky**, aby byla data porovnatelná a reflektovala platná pravidla úhrad.
...
Poskytuje přehled pacientů s vysokými náklady. V rozšířené verzi zobrazuje hodnoty jako PURO × 5, překročení v Kč a %, a jejich barevné označení.
